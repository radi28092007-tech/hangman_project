...
def get_fernet_keyring_username():
    ...
    return f"fernet-encryption-key-{path_hash}"


KEYRING_USERNAME = get_fernet_keyring_username()
...
def load_secret_key():
    ...
    keyring.set_password(KEYRING_SERVICE, KEYRING_USERNAME, secret_key.decode("ascii"))
...
def ask_menu_choice(prompt, choices):
    ...
    while True:
        choice = console.input( f"[bold yellow]{prompt}[/bold yellow] "f"[bold #E6B3FF][{choices_text}][/bold #E6B3FF]: ").strip()
...
def authentication():
    ...
    while attempts < 3:
        ...
        if choice == "0":
            ...
            encrypted_secret = user_record.get("totp_secret")
            ...
            if totp.verify(user_code, valid_window=1):
                ...
                while True:
                    ...
                    if not is_strong_password(new_password):
                        print("At least 8 characters, at least 1 number, 1 uppercase letter, and 1 special character")
                        continue
            ...
            print("1. Open your authenticator app (e.g., Google Authenticator).")
            print("2. Add a new account manually using this secret key:")
            print(f"    {totp_secret}")
            ...
            if user_found and password_correct:
                ...
                while two_fa_attempts < 3:
                    ...
                    print(f"\n--- 2FA VERIFICATION REQUIRED "f"(Attempts left: {3 - two_fa_attempts})")
            ...
            for delete_attempt in range(3):
                ...
                print(f"\n--- DELETE ACCOUNT VERIFICATION " f"(Attempts left: {3 - delete_attempt}) ---")
